#ifndef RFNOC_PROGRAMMABLEDEVICE_PROG_BASE_IMPL_REPROG_H
#define RFNOC_PROGRAMMABLEDEVICE_PROG_BASE_IMPL_REPROG_H
...
class RFNoC_ProgrammableDevice_prog_base;

template <typename HW_LOAD_REQUEST, typename HW_LOAD_STATUS>
class RFNoC_ProgrammableDevice_prog_base : public RFNoC_ProgrammableDevice_base
{
    ENABLE_LOGGING;
    ...
    public:
        ...
        typedef RFNoC_ProgrammableDevice_prog_base<HW_LOAD_REQUEST BOOST_PP_COMMA()
                             HW_LOAD_STATUS> RFNoC_ProgrammableDevice_prog_base_type;

        RFNoC_ProgrammableDevice_prog_base (
                                    char            *devMgr_ior,
                                    char            *id,
                                    char            *lbl,
                                    char            *sftwrPrfl )
                ...
                CORBA::SystemException ) 
        {
            ...
            RFNoC_ProgrammableDevice_base::load(fs, fileName, loadKind);
        }
                ...
                CORBA::SystemException )
        {
            ...
            if (persona == NULL) {
                LOG_FATAL(RFNoC_ProgrammableDevice_prog_base, __FUNCTION__ << 
                ...
                CORBA::SystemException ) 
        {
            ...
            LOG_WARN(RFNoC_ProgrammableDevice_prog_base, __FUNCTION__ << 
                ...
                CORBA::SystemException ) 
        {
            ...
            updateAdminStates();
            LOG_DEBUG(RFNoC_ProgrammableDevice_prog_base, __FUNCTION__ << ": Allocation Result: " << allocationSuccess);
    ...
    protected:
                                    ...
                                    const CF::Properties&       parameters) 
        {
            ...
            for (size_t ii = 0; ii < combinedProps.length(); ii++) {
                ...
                LOG_DEBUG(RFNoC_ProgrammableDevice_prog_base, "ARGV[" << id << "]: " << val);
            }
            ...
            if (hasAnInactiveHwLoadStatus()) {
                ...
                for (iter = _personaMap.begin(); iter != _personaMap.end(); iter++) {
                    ...
                    if (strVecContainsStr(allRequesterIds, iter->first)) {
                        LOG_DEBUG(RFNoC_ProgrammableDevice_prog_base, "It does contain it");
                ...
                LOG_DEBUG(RFNoC_ProgrammableDevice_prog_base, "After setAdminState");
            }
        }
...
template <typename HW_LOAD_REQUEST, typename HW_LOAD_STATUS>
PREPARE_ALT_LOGGING(RFNoC_ProgrammableDevice_prog_base<HW_LOAD_REQUEST BOOST_PP_COMMA() 
                                 HW_LOAD_STATUS>, RFNoC_ProgrammableDevice_prog_base);

#endif // RFNOC_PROGRAMMABLEDEVICE_PROG_BASE_IMPL_REPROG_H
