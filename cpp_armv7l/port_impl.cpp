/*******************************************************************************************
    ...
    Source: RFNoC_ProgrammableDevice.spd.xml
...
// ----------------------------------------------------------------------------------------
FRONTEND_DigitalTuner_In_i::FRONTEND_DigitalTuner_In_i(std::string port_name, RFNoC_ProgrammableDevice_base *_parent) : 
Port_Provides_base_impl(port_name)
{
    parent = static_cast<RFNoC_ProgrammableDevice_i *> (_parent);
}
...
// ----------------------------------------------------------------------------------------
FRONTEND_RFInfo_In_i::FRONTEND_RFInfo_In_i(std::string port_name, RFNoC_ProgrammableDevice_base *_parent) : 
Port_Provides_base_impl(port_name)
{
    parent = static_cast<RFNoC_ProgrammableDevice_i *> (_parent);
}
