...
class RFNoC_ProgrammableDevice_base;
...
{
    public:
        FRONTEND_DigitalTuner_In_i(std::string port_name, RFNoC_ProgrammableDevice_base *_parent);
    ...
    protected:
        RFNoC_ProgrammableDevice_i *parent;
...
{
    public:
        FRONTEND_RFInfo_In_i(std::string port_name, RFNoC_ProgrammableDevice_base *_parent);
